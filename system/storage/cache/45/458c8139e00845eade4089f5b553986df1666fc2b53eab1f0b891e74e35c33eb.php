...
/* install/step_4.twig */
class __TwigTemplate_4bf5adb26749d43e829b1dd7dd75c3cf18423b5937e2129b7ba899349ef8ca9e extends Twig_Template
{
...
\t  <div class=\"col-sm-4\"><a href=\"https://vk.com/ocstore\" class=\"icon transition\"><i class=\"fa fa-vk fa-4x\"></i></a>
        <h3>";
        // line 64
        echo (isset($context["text_vkontakte"]) ? $context["text_vkontakte"] : null);
        echo "</h3>
        <p>";
        // line 65
        echo (isset($context["text_vkontakte_description"]) ? $context["text_vkontakte_description"] : null);
        echo "</p>
        <a href=\"https://vk.com/ocstore\">";
        // line 66
        echo (isset($context["text_vkontakte_visit"]) ? $context["text_vkontakte_visit"] : null);
        echo "</a></div>
...
/*     </div>*/
/*     <div class="row">*/
/*       <div class="col-sm-12 text-center"><a href="https://opencartforum.com/files/&utm_source=ocstore_install&utm_medium=store_link&utm_campaign=ocstore_install" target="_BLANK" class="btn btn-default">{{ text_extension }}</a></div>*/
/*     </div>*/
/*   </div>*/
/*   <div class="mailing">*/
/*     <div class="row">*/
...
/*         <a href="https://ocstore.com/subscribe/" target="_BLANK" class="btn btn-secondary">{{ button_mail }}</a></div>*/
/*     </div>*/
/*   </div>*/
/*   <div class="core-modules">*/
/*     <div class="row">*/
...
/*         <a href="https://www.facebook.com/ocstore">{{ text_facebook_visit }}</a></div>*/
/* 	  <div class="col-sm-4"><a href="https://vk.com/ocstore" class="icon transition"><i class="fa fa-vk fa-4x"></i></a>*/
/*         <h3>{{ text_vkontakte }}</h3>*/
/*         <p>{{ text_vkontakte_description }}</p>*/
/*         <a href="https://vk.com/ocstore">{{ text_vkontakte_visit }}</a></div>*/
/*       <div class="col-sm-4"><a href="https://opencartforum.com/?utm_source=ocstore_install&utm_medium=forum_link&utm_campaign=ocstore_install" class="icon transition"><i class="fa fa-comments fa-4x"></i></a>*/
/*         <h3>{{ text_forum }}</h3>*/
/*         <p>{{ text_forum_description }}</p>*/
/*         <a href="https://opencartforum.com/?utm_source=ocstore_install&utm_medium=forum_link&utm_campaign=ocstore_install">{{ text_forum_visit }}</a></div>*/
/*     </div>*/
/*   </div>*/
/* </div>*/
/* {{ footer }}*/
